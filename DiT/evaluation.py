...
def main():
    ...
    parser.add_argument("--ref_batch", type=str, help="Path to reference images directory or npz file", default="/data/home/jiangkai/LightningDiT/VIRTUAL_imagenet256_labeled.npz")
    parser.add_argument("--sample_batch", type=str, help="Path to sample images directory or npz file", default="")
